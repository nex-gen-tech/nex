...
var validationFuncsMap map[string]ValidationFunc

func init() {
	vf := NewValidationFuncs()
	validationFuncsMap = map[string]ValidationFunc{
		"required":       vf.IsRequired,
		"email":          vf.IsEmail,
		"url":            vf.IsURL,
		"alpha":          vf.IsAlpha,
		"alphanum":       vf.IsAlphaNumeric,
		"numeric":        vf.IsNumeric,
		"hexadecimal":    vf.IsHexadecimal,
		"hexcolor":       vf.IsHexColor,
		"rgb":            vf.IsRGBColor,
		"rgba":           vf.IsRGBAColor,
		"hsl":            vf.IsHSLColor,
		"hsla":           vf.IsHSLAColor,
		"json":           vf.IsJSON,
		"multibyte":      vf.IsMultibyte,
		"ascii":          vf.IsASCII,
		"printableascii": vf.IsPrintableASCII,
		"fullwidth":      vf.IsFullWidth,
		"variablewidth":  vf.IsVariableWidth,
		"base64":         vf.IsBase64,
		"datauri":        vf.IsDataURI,
		"ip":             vf.IsIP,
		"ipv4":           vf.IsIPv4,
		"ipv6":           vf.IsIPv6,
		"cidr":           vf.IsCIDR,
		"cidrv4":         vf.IsCIDRv4,
		"cidrv6":         vf.IsCIDRv6,
		"tcpaddr":        vf.IsTCPAddr,
		"udpaddr":        vf.IsUDPAddr,
		"latitude":       vf.IsLatitude,
		"longitude":      vf.IsLongitude,
		"ssn":            vf.IsSSN,
		"semver":         vf.IsSemver,
		"isbn10":         vf.IsISBN10,
		"isbn13":         vf.IsISBN13,
		...
		"uuid4":          vf.IsUUID4,
		"uuid5":          vf.IsUUID5,
		"creditcard":     vf.IsCreditCard,
		"isbn":           vf.IsISBN,
		"minlen":         vf.MinLen,
		"maxlen":         vf.MaxLen,
		"len":            vf.Len,
		"eqfield":        vf.EqField,
		"eqcsfield":      vf.EqCrossStructField,
		"necsfield":      vf.NeCrossStructField,
		"gtfield":        vf.GtField,
		"gtefield":       vf.GteField,
		"ltfield":        vf.LtField,
		"ltefield":       vf.LteField,
		"nefield":        vf.NeField,
